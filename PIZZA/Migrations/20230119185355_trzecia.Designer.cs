...
namespace PIZZA.Data.Migrations
{
    ...
    [Migration("20230119185355_trzecia")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PIZZA.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PIZZA.Models.PIZZA.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PIZZA.Models.PIZZA.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PIZZA.Models.Order", b =>
                {
                    b.HasOne("PIZZA.Models.PIZZA.Models.ApplicationUser", "User")
                        .WithMany("Orders")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
